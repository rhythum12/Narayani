...
const Testimonials = () => {
  return (
    <div className="h-auto pb-8 pt-14 px-4 sm:px-6 lg:px-8 xl:px-10 mb-11">
      ...
      >
        <section className="flex bg-white ">
          <SwiperSlide>
            <div className="max-w-screen-xl  mx-auto text-center lg:py-4 lg:px-6 border border-gray-200 rounded-3xl shadow   dark:border-gray-700">
